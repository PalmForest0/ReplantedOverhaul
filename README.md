...
- [ ] Allow the game to run in the background without the need for another mod.
...
2. Make changes that follow the existing project conventions
3. Test all implemented or modified functionality in-game
